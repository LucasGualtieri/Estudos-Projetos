...
public void WeaponSwitchPost(int client, int weapon) {
   ...
   if (item_def_index == 60 || item_def_index == 7 || item_def_index == 16 || item_def_index == 39|| item_def_index == 8) {
...
public void PostThink(int client) {
   if (IsPlayerAlive(client)) {
      ...
      bool isScoped = playerCurFov[client] < GetEntProp(client, Prop_Data, "m_iDefaultFOV");
      
      if (isScoped) {
         accuracyThreshold[client] = 2601.0;
      } else if (currentWeaponID == 60 || currentWeaponID == 7 || currentWeaponID == 16 || currentWeaponID == 39 || currentWeaponID == 8) {
